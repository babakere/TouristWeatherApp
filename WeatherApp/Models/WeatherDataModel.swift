...
// structure representing the model for the weather data, conforming tocodable and identifiable protocols
...
// MARK: - Current
// structure represents current weather deatails, conforming to codable and identifiable
...
// MARK: - Rain
// a structure representing details about the rain, conforming to codable protocol
struct Rain: Codable {
    let the1H: Double
...
// MARK: - Weather
// structure representing details about weather, conforming to codable protocol
...
// enumeration representing detailed weather conditions
...
enum Description: String, Codable {
    ...
    case unknown = "unknown"
       ...
       // Adding a custom initializer to handle unknown values during decoding
       init(from decoder: Decoder) throws {
           let container = try decoder.singleValueContainer()
           do {
               self = try .init(rawValue: container.decode(RawValue.self)) ?? .unknown
           } catch {
               self = .unknown
           }
       }
...
// MARK: - Daily
// this structure represents the daily details, conforming to codable and identifiable
...
// MARK: - FeelsLike
// the structure represents feel-like temperature details, conforming to codable protocol
struct FeelsLike: Codable {
    let day, night, eve, morn: Double
}

// MARK: - Temp
// structure represents temperature details, conforming to codable protocol
struct Temp: Codable {
...
// MARK: - Minutely
//structure represents minutely weather details, conforming to codable protocol
